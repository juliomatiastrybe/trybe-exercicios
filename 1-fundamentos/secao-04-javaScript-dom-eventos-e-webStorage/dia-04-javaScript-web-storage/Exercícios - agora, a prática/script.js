window.onload = () => {
    // estaura o backgroundColor
    const restoreBackgroundColor = () => {
      if (localStorage.getItem('backgroudColor') !== null) {
        const restoreColor = JSON.parse(localStorage.getItem('backgroudColor'));
        const constent = document.querySelector(".content");
        constent.style.backgroundColor = restoreColor
      }
    }
    restoreBackgroundColor();
    // guarda o backgroundColor
